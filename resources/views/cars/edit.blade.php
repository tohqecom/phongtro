            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default border">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('cars-update',$car->id) }}">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <h2>Main info:</h2>
                            <div class="form-group{{ $errors->has('brand') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="brand" type="text" class="form-control grey-glow" name="brand" value="{{ $car->brand }}"  autofocus/>
                            ...
                            <div class="form-group{{ $errors->has('model') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="model" type="text" class="form-control grey-glow" name="model" value="{{ $car->model }}" />
                            ...
                            <div class="form-group{{ $errors->has('production-year') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="production-year" type="integer" class="form-control grey-glow" name="production-year"  value="{{ $car->productionYear }}"/>
                            ...
                            <div class="form-group{{ $errors->has('cost') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="cost" type="number" class="form-control grey-glow" name="cost"  value="{{$car->cost}}" />
                            ...
                            <div class="form-group{{ $errors->has('fuel-consumption') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="fuel-consumption" type="text" class="form-control grey-glow" name="fuel-consumption"  value="{{ number_format($car->fuel_consumption,1) }}"/>
                            ...
                            <div class="form-group{{ $errors->has('engine-capacity') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="engine-capacity" type="number" class="form-control grey-glow" name="engine-capacity" value="{{$car->engine_capacity}}"/>
                            ...
                            <div class="form-group{{ $errors->has('engine-power') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="engine-power" type="number" class="form-control grey-glow" name="engine-power" value="{{$car->engine_power}}" />
                            ...
                            <div class="form-group{{ $errors->has('seats') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="seats" type="number" class="form-control grey-glow" name="seats" value="{{$car->seats}}"/>
                            ...
                            <div class="form-group{{ $errors->has('available') ? ' has-error' : '' }}">
                                <label for="seats" class="col-md-4 control-label">Available:</label>

                                <div class="col-md-6">
                                    <input id="available" type="checkbox" class="form-control grey-glow" name="available" >
